...
from compass_metrics_v2.issue_metrics_v2 import (issue_new_first_response_time_by_period,
...
class BaseMetricsModel:
    def __init__(self, repo_index, git_index, issue_index, pr_index, issue_comments_index, pr_comments_index,
        ...
        if type(custom_fields) == dict:
            ...
            self.period = self.custom_fields.get('period')
        else:
            self.custom_fields = {}
    ...
    def metrics_model_enrich(self, repo_list, label, level, type=None):
        ...
        date_list = get_date_list_by_period(self.from_date, self.end_date,period)
        item_datas = []
    ...
    def get_metrics(self, date, repo_list, period='month'):
        metrics_switch = {
            ...
            "issue_new_first_response_time_by_period": lambda: issue_new_first_response_time_by_period(self.client, self.issue_index, date, repo_list,period),
            "issue_new_unresponsive_ratio_by_period": lambda: issue_new_unresponsive_ratio_by_period(self.client, self.issue_index,  date, repo_list,period),
            "issue_new_handle_time_by_period": lambda: issue_new_handle_time_by_period(self.client, self.issue_index, date, repo_list,period),
            "pr_new_unresponsive_ratio_by_period": lambda: pr_new_unresponsive_ratio_by_period(self.client, self.pr_index, date, repo_list,period),
            "pr_new_handle_time_by_period": lambda: pr_new_handle_time_by_period(self.client, self.pr_index, date, repo_list,period),
            ...
            "participating_orgs_by_period": lambda: participating_orgs_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_code_contributors_by_period": lambda: org_code_contributors_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_code_contributors_ratio_by_period": lambda: org_code_contributors_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_non_code_contributors_by_period": lambda: org_non_code_contributors_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_non_code_contributors_ratio_by_period": lambda: org_non_code_contributors_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "governance_orgs_by_period": lambda: governance_orgs_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_managers_by_period": lambda: org_managers_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_managers_ratio_by_period": lambda: org_managers_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_code_contributors_by_period": lambda: individual_code_contributors_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_code_contributors_ratio_by_period": lambda: individual_code_contributors_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_non_code_contributors_by_period": lambda: individual_non_code_contributors_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_non_code_contributors_ratio_by_period": lambda: individual_non_code_contributors_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),

            "org_code_contribution_by_period": lambda: org_code_contribution_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_code_contribution_ratio_by_period": lambda: org_code_contribution_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_code_contribution_by_period": lambda: individual_code_contribution_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_code_contribution_ratio_by_period": lambda: individual_code_contribution_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_non_code_contribution_by_period": lambda: org_non_code_contribution_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "org_non_code_contribution_ratio_by_period": lambda: org_non_code_contribution_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),

            "individual_managers_by_period": lambda: individual_managers_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_managers_ratio_by_period": lambda: individual_managers_ratio_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
            "individual_non_code_contribution_by_period": lambda: individual_non_code_contribution_by_period(self.client,self.contributors_enriched_index, date, repo_list,period),
